...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['Selenium WebDriver', 'TestNG', 'JUnit', 'Playwright'],
    description: 'Architecting scalable Selenium + TestNG frameworks from the ground up, cutting regression cycle time and boosting release confidence.',
    stat: '75% FASTER REGRESSION',
    colSpan: 'lg:col-span-7',
  },
  {
    title: 'API & BACKEND VALIDATION',
    badge: 'DATA INTEGRITY',
    items: ['REST Assured', 'Postman', 'SQL', 'MySQL'],
    description: 'Engineering robust API automation suites and SQL-based backend validation to guarantee data integrity across services.',
    stat: '50% FASTER TRIAGE',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'CI/CD & DEVOPS',
    badge: 'CONTINUOUS TESTING',
    items: ['Jenkins', 'Git', 'GitHub', 'Azure DevOps'],
    description: 'Integrating automated test suites into Jenkins pipelines for continuous testing, faster feedback loops, and seamless DevOps alignment.',
    stat: '70% FASTER DEPLOYS',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'QA LEADERSHIP & METHODOLOGY',
    badge: 'PROCESS',
    items: ['Agile (Scrum)', 'JIRA', 'Bugzilla', 'STLC', 'UAT'],
    description: '10+ years leading Agile QA transformation across Banking, Insurance, and EdTech — defect lifecycle management, sprint planning, and stakeholder-driven UAT.',
    stat: '80% FEWER DEFECTS',
    colSpan: 'lg:col-span-7',
  },
];
