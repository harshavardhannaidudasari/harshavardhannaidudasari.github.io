...
const journey: RouteStop[] = [
  {
    ...
    organization: 'RITVIN SOFTWARE SOLUTIONS (RRS), HYDERABAD',
    description: 'Led automation strategy for a SAP Supply Chain Management platform — designed a Selenium + TestNG framework accelerating regression cycles by 40%, integrated Jenkins CI/CD, and drove Agile QA across procurement, inventory, and logistics workflows.',
  },
  {
    id: '02',
    year: 'SEP 2021 - SEP 2022',
    title: 'SENIOR QUALITY ANALYST',
    organization: 'DBS BANK, HYDERABAD',
    description: 'Validated the DBS Digital Investment & Bonds banking platform — engineered test scenarios using BVA/ECP techniques, ran cross-browser regression on financial workflows, and supported UAT for secure banking operations.',
  },
  {
    id: '03',
    year: 'JUN 2020 - AUG 2021',
    title: 'SENIOR QUALITY ASSURANCE',
    organization: 'COVERFOX INSURANCE, MUMBAI',
    description: 'Tested an insurance aggregation platform spanning health, motor, and life plans — validated premium calculation engines, payment gateway integrations, and policy issuance across multiple providers.',
  },
  {
    id: '04',
    year: 'MAY 2019 - JUN 2020',
    title: 'SENIOR QUALITY ANALYST',
    organization: 'TESTBOOK.COM, NAVI MUMBAI',
    description: 'Built Selenium automation for an EdTech platform serving government exam aspirants — mock tests, live classes, and performance analytics — with SQL-based backend validation.',
  },
  {
    id: '05',
    year: 'OCT 2016 - NOV 2019',
    title: 'SENIOR QUALITY ANALYST',
    organization: 'CARTRONICS TECHNOLOGIES, BENGALURU',
    description: 'Owned QA for a school billing & student management system and an e-commerce order management platform — end-to-end test planning, defect lifecycle, and UAT coordination with clients.',
  },
  {
    id: '06',
    year: 'CERTIFIED',
    title: 'PMP & ISTQB FOUNDATION',
    organization: 'GREAT LEARNING / ISTQB',
    description: 'PMP certified (Great Learning) and ISTQB Foundation Level 4.0 certified, grounding QA leadership in formal project management and testing standards.',
  },
  {
    id: '07',
    year: '2010 - 2013',
    title: 'B.SC. COMPUTER SCIENCE',
    organization: 'VINAYAKA MISSIONS UNIVERSITY',
    description: 'Bachelor of Science in Computer Science, First Class — the technical foundation for a decade-long career in software quality engineering.',
  },
];
